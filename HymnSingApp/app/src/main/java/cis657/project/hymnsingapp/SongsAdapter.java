...
import cis657.project.hymnsingapp.SongsFragment.OnListFragmentInteractionListener;
import cis657.project.hymnsingapp.dummy.DummyContent.DummySong;
...
public class SongsAdapter extends RecyclerView.Adapter<SongsAdapter.ViewHolder> {
    ...
    public SongsAdapter(List<DummySong> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
